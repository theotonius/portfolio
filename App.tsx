          ...
          <div className="max-w-3xl mx-auto glass rounded-[3rem] p-10 md:p-16 text-center">
            ...
            <div className="flex justify-center gap-6 mb-12">
              <a 
                ...
                className="group p-4 glass rounded-2xl hover:border-sky-500/50 hover:bg-white/5 transition-all duration-300 transform hover:-translate-y-1"
                title="GitHub"
              >
              ...
              <a 
                ...
                title="LinkedIn"
              >
                <svg className="w-8 h-8 text-slate-300 group-hover:text-sky-400 transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a 
                ...
                title="Twitter"
              >
                <svg className="w-8 h-8 text-slate-300 group-hover:text-sky-300 transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <form className="space-y-4 max-w-lg mx-auto">
              <input 
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-6 py-4 focus:outline-none focus:border-sky-500/50 transition-all text-slate-200 placeholder-slate-500"
              />
              <input 
                type="email" 
              ...
              <textarea 
                ...
                className="w-full bg-slate-800/50 border border-slate-700 rounded-xl px-6 py-4 focus:outline-none focus:border-sky-500/50 transition-all text-slate-200 placeholder-slate-500"
              ></textarea>
              <button className="w-full py-4 bg-sky-600 hover:bg-sky-500 text-white rounded-xl font-bold transition-all transform active:scale-95 shadow-lg shadow-sky-600/20">
                Send Message
              </button>
            </form>
          </div>
